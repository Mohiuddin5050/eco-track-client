        ...
        <div className="carousel w-full h-[420px] rounded-xl shadow-lg mt-6">
            ...
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute inset-0 bg-opacity-40 flex flex-col justify-center items-center text-white text-center p-4">
                    ...
                    <Link to="/challenges" className="btn btn-primary mt-4">Get Started</Link>
                </div>
            ...
            <div id="slide2" className="carousel-item relative w-full">
                ...
                <div className="absolute inset-0 bg-opacity-40 flex flex-col justify-center items-center text-white text-center p-4">
                    ...
                    <Link to="/activities" className="btn btn-primary mt-4">Explore Activities</Link>
                </div>
            ...
            <div id="slide3" className="carousel-item relative w-full">
                ...
                <div className="absolute inset-0 bg-opacity-40 flex flex-col justify-center items-center text-white text-center p-4">
                    ...
                    <Link to="/register" className="btn btn-primary mt-4">Join Now</Link>
                </div>
